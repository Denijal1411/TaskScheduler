...
namespace TaskScheduler.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UserController : TaskScheduler.Controllers.UserController
    {
        ...
        [NonAction]
        partial void AddUserOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, TaskScheduler.Models.CreateUserModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult AddUser(TaskScheduler.Models.CreateUserModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.AddUser);
        ...
        [NonAction]
        partial void EditUserOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, TaskScheduler.Models.CreateUserModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult EditUser(TaskScheduler.Models.CreateUserModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.EditUser);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
