...
{
    public static TaskScheduler.Controllers.HomeController Home = new TaskScheduler.Controllers.T4MVC_HomeController();
    public static TaskScheduler.Controllers.ProjectController Project = new TaskScheduler.Controllers.T4MVC_ProjectController();
    public static TaskScheduler.Controllers.TaskController Task = new TaskScheduler.Controllers.T4MVC_TaskController();
    public static TaskScheduler.Controllers.UserController User = new TaskScheduler.Controllers.T4MVC_UserController();
