...
namespace TaskScheduler.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : TaskScheduler.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, TaskScheduler.Models.UserModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Login(TaskScheduler.Models.UserModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
