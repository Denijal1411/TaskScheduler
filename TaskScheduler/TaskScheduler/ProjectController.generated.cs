...
namespace TaskScheduler.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProjectController : TaskScheduler.Controllers.ProjectController
    {
        ...
        [NonAction]
        partial void AddProjectOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, TaskScheduler.Models.ProjectModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult AddProject(TaskScheduler.Models.ProjectModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.AddProject);
        ...
        [NonAction]
        partial void EditProjectOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, TaskScheduler.Models.ProjectModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult EditProject(TaskScheduler.Models.ProjectModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.EditProject);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
